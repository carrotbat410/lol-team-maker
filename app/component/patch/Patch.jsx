  ...
  if (pageNo === 1) {
    return (
      <div className={styles.patch_log_div}>
        ...
        꼭 읽어주시면 감사하겠습니다:)
        <br/>
        <h2><del>1. 주라인 옵션 도입</del> → 적용 완료</h2>
        주라인을 고려한 팀 매칭 결과 모드인 "Line Balance"모드가 도입되었습니다.<br/>
        "사용법 보기"를 참고해주세요!<br/>
        버그 발견시 혹은 궁금한점에 대해 문의글을 남겨주시면 감사하겠습니다.
  ...
  if (pageNo === 3) {
    return (
      <div className={styles.patch_log_div}>
        ...
        개인적으로 힘든 시기에, 유저분들의 피드백과 응원글이 큰 힘이 되었던 경험이 있네요!<br/><br/>
        두서 없이 적었네요 ㅎㅎ... 항상 이용해주셔서 감사하고, 즐거운 내전 시간 보내시길 바랍니다!<br/><br/>
        <br/><br/>
