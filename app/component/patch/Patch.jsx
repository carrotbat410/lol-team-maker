...
function DescriptionText({ pageNo }) {
  if (pageNo === 1) {
    return (
      <div className={styles.patch_log_div}>
        ...
        2. 다른 모드에서 주라인 모드로 변경시 화면이 초기화되고 (리셋 버튼 한번 누른것과 동일)<br/><br/>
  ...
  if (pageNo === 2) {
    return (
      <div className={styles.patch_log_div}>
        ...
        사이트 사용법에 대해 좀 더 자세히, 여러 정보들을 가독성 좋게 제공하겠습니다.
  ...
  if (pageNo === 3) {
    return (
      <div className={styles.patch_log_div}>
        <h2>하고싶은말</h2>
        빠르게 기능들을 추가하고 더 멋지게 꾸미고 싶었지만, 회사일에 시간 + 체력이 없네요 ㅠㅠ<br/><br/>
        느리지만 하나씩 개선하겠습니다 (주라인 모드만큼은 최대한 빠르게 도입하려 합니다)<br/><br/>
        또한 사이트 이용에 관해서(버그, 이용법, 피드백등...) 정말 편하게 문의글 남겨주셔도 좋습니다~!<br/><br/>
        개인적으로 힘든 시기에, 유저분들의 "애정섞인 피드백과 응원글"이 큰 힘이 되었네요!<br/><br/>
        두서 없이 적었네요ㅎㅎ.. 이용해주셔서 감사하고, 즐거운 내전 시간 보내시길 바랍니다!<br/><br/>
        <br/><br/>
